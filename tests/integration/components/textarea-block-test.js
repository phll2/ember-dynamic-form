...
moduleForComponent('textarea-block', 'Integration | Component | textarea block', {
  integration: true
});
...
test('value is accepted', function(assert) {
  ...
  this.render(hbs`{{textarea-block value=value}}`);
...
test('if label is not specified, a prompt to provide one is used instead', function(assert) {
  assert.expect(1);
  this.render(hbs`{{textarea-block}}`);
...
test('label is accepted', function(assert) {
  ...
  this.render(hbs`{{textarea-block label=label}}`);
...
test('cols can be specified', function(assert) {
  ...
  let cols = 20;
  this.set('cols', cols);
  this.render(hbs`{{textarea-block cols=cols}}`);
...
test('rows can be specified', function(assert) {
  ...
  let rows = 2;
  this.set('rows', rows);
  this.render(hbs`{{textarea-block rows=rows}}`);
...
test('textareaId can be specified', function(assert) {
  ...
  this.render(hbs`{{textarea-block textareaId=textareaId}}`);
...
test('required can be set', function(assert) {
  assert.expect(1);
  this.render(hbs`{{textarea-block required=true}}`);
...
test('the onValueUpdate action sends the value up to the bound action', function(assert) {
  ...
  this.render(hbs`{{textarea-block onValueUpdate=(action "mockOnValueUpdate")}}`);
